...
@section('content')
  <div class="vr_dl_1">
    ...
    <div class="vr_szxx">
        <a href="{{url('register')}}" class="public_btn">添加用户</a>
        ...
        @foreach($data as $key=>$item)
          <tr>
            ...
            @if($item['user_status'])
              ...
              <td height="50" align="center" valign="middle"><a href="{{url('/user/edit?id='.$item['id'])}}">修改</a> | <a href="javascript:{};" onclick="updateStatus(this);" userid="{{$item['id']}}" status="{{$item['user_status']}}" class="lan_1 ry_zs_tj">冻结</a></td>
            @else
              <td height="50" align="center" valign="middle" class="lan_1">冻结</td>
              <td height="50" align="center" valign="middle"><a href="{{url('/user/edit?id='.$item['id'])}}">修改</a> | <a href="javascript:{};" onclick="updateStatus(this);" userid="{{$item['id']}}" status="{{$item['user_status']}}" class="lv ry_zs_gai">开启</a></td>
            @endif
          </tr>
        @endforeach
      </table>

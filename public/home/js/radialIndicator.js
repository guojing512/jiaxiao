...
;(function ($, window, document) {
    ...
    Indicator.prototype = {
        ...
        value: function (val) {
            ...
            if (indOption.displayNumber) {
				...
				//新增单位
				if(indOption.appendTxt != null){
					dispVal = dispVal + indOption.appendTxt;
				}
				//新增单位end
                ctx.fillStyle = indOption.fontColor || curColor;
                ctx.font = fontStyle+' '+weight +" "+ fontSize + "px " + cFont;
        ...
        animate: function (val) {
            ...
            var indOption = this.indOption,
                ...
                self = this,
                incBy = Math.ceil((indOption.maxValue - indOption.minValue) / (indOption.frameNum || (indOption.percentage ? 10 : 500))), //increment by .2% on every tick and 1% if showing as percentage
                back = val < counter;
    ...
    radialIndicator.defaults = {
        ...
        fontStyle: 'normal', //新增 字体
        appendTxt: null, //新增 文字,数字后面加文字/单位
